...
TEST_CASE("projection to a 3d triangulated surface", "[nearest]") {
    ...
    *m.points.data = {{1, 0, 0}, {0, 1, 0}, {0, 0, 1}, {0, 0, 0}};
    ...
    PointOnMesh p1 = bvh.nearest_point({0.8311, 0.0224465, 1.00753});
